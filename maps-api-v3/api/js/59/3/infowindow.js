google.maps.__gjsload__('infowindow', function(_) {
    var rN = function(a) {
        ...
        uN = function(a) {
            ...
            b === a.Jg ? a.Hg.style.display = e ? "" : "none" : (a.Jg && (c = a.Jg.parentNode, c === a.Kg && c.removeChild(a.Jg)),
                b && (a.Og = !1, a.Kg.appendChild(b), e && !d && FSa(a)), a.Hg.style.display = e ? "" : "none", a.Jg = b, tN(a))
        },
        tN = function(a) {
            var b = a.getSize();
            if (b) {
        ...
        JSa = function(a, b, c) {
            return b instanceof _.pl ? new ISa(a,
                b, c) : new ISa(a, b)
        },
        LSa = function(a) {
        ...
        NSa = function(a) {
            a = a.__gm;
            a.get("IW_AUTO_CLOSER") || a.set("IW_AUTO_CLOSER", new MSa);
    ...
    var CSa = class extends _.Xk {
        ...
        ariaLabel_changed() {
            ...
            a ? this.Mi.setAttribute("aria-label", a) : (this.Mi.removeAttribute("aria-label"), this.get("headerDisabled") || FSa(this))
        }
        open_changed() {
            GSa(this);
            uN(this)
        ...
        constructor(a, b, c) {
            ...
            (d = b instanceof _.pl) && c ? c.then(h => {
                this.isOpen && (this.ah = h, this.Eg = new _.GK(k => {
                    ...
                    h.Ii(this.Hg);
                    return this.Hg
                }), this.Eg.bindTo("latLngPosition", a, "position"), LSa(this))
                ...
                e), this.Eg.bindTo("projection", b), this.Eg.bindTo("focus", b, "position"), LSa(this));
            ...
            this.Fg = new _.an(() => {
                if (b instanceof _.pl)
                    if (this.ah) {
                        ...
                        h && (0, _.coa.zE)(b, this.ah, new _.vl(h), HSa(g))
                    } else c.then(() => {
                        this.Fg.start()
                    });
            ...
            _.Sk(a, "map_changed", function d() {
                ...
                if (e) {
                    ...
                    f.get("panes") ? f.get("innerContainer") ? (b = {
                        nK: JSa(a, e, e instanceof _.pl ? f.Fg.then(({
                            ah: g
                        }) => g) : void 0),
                        zC: NSa(e)
                    }, BSa(b.zC, a)) : _.Rk(f, "innercontainer_changed", d) : _.Rk(f, "panes_changed", d)
                }
            })
        }
    });
