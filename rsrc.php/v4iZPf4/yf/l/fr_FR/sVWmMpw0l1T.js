        ...
        k = {
            ...
            runCSSPolls: function() {
                ...
                if (b != null && Date.now() >= b) {
                    ...
                    for (f = j, e = Array.isArray(f), d = 0, f = e ? f : f[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                        if (e) {
                            if (d >= f.length) break;
                            b = f[d++]
                        } else {
                        ...
                        try {
                            ...
                            if (l != null) {
                                ...
                                m != null && (a.push(b.onLoad), j["delete"](g), c("FBLogger")("CSSPoller").info("Poll technique was able to poll CSS"))
                            }
                        } catch (a) {
...
__d("HasteBitMapKey", [], (function(a, b, c, d, e, f) {
    a = Object.freeze({
        CSR: 0,
        HSDP: 1,
        HBLP: 2
...
__d("HasteBitMap", ["BitMap", "BootloaderConfig", "HasteBitMapKey"], (function(a, b, c, d, e, f, g) {
    var h = new(c("BitMap"))();

    function a(a, b) {
        !c("BootloaderConfig").phdSeparateBitmaps ? h.set(b) : h.set(b * Object.values(c("HasteBitMapKey")).length + Number(a))
    }
...
__d("GHLDetectionUtils", ["gkx"], (function(a, b, c, d, e, f, g) {
    ...
    function b() {
        return typeof XMLHttpRequest === "function" && !(XMLHttpRequest.toString === XMLHttpRequest.toString.toString && h(XMLHttpRequest.toString()) === "function XMLHttpRequest() { [native code] }" && h(XMLHttpRequest.toString.toString()) === "function toString() { [native code] }")
    }

    function d(a) {
        return typeof a === "function" && !(a.toString === a.toString.toString && h(a.toString()) === "function XMLHttpRequest() { [native code] }" && h(a.toString.toString()) === "function toString() { [native code] }")
    }
...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderDocumentInserter", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "BootloaderPreloader", "BootloaderRetryTracker", "CSSLoader", "ClientConsistency", "ErrorPubSub", "ExecutionEnvironment", "FBLogger", "HasteBitMap", "HasteResourceIndexUtil", "JSResourceReferenceImpl", "MakeHasteTranslations", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "SiteData", "TimeSlice", "TrustedTypesBootloaderDataURIScriptURLPolicy", "TrustedTypesMetaURIScriptURLPolicy", "__debug", "clearTimeout", "cr:696703", "err", "fb-error", "ifRequireable", "ifRequired", "nullthrows", "objectKeys", "performanceAbsoluteNow", "performanceNow", "promiseDone", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g, h) {
    ...
    function R(a, b, e, f) {
        ...
        switch (b.type) {
            ...
            case "css":
                ...
                c("CSSLoader").loadStyleSheet(a, b.src, c("nullthrows")(e), !b.nc, b.m, n, O(a, b, n));
                break;
            case "async":
    ...
    function T(a, b, e) {
        ...
        if (f)
            for (var f = d("HasteResourceIndexUtil").parseResourceIndexes(f), g = Array.isArray(f), h = 0, f = g ? f : f[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                ...
                i = i;
                if (i === d("HasteResourceIndexUtil").UNKNOWN_RESOURCE_INDEX) continue;
                (!w.has(i) || e) && w.set(i, a);
                (c("BootloaderConfig").phdOn && !c("BootloaderConfig").phdSeparateBitmaps ? b.c == 2 : b.c) && d("HasteBitMap").add(0, i)
            }
    }
    ...
    function W(a) {
        ...
        for (var e = 0; e < a.length; e++) {
            ...
            var i = void 0;
            if (g.type === "csr") i = d("HasteResourceIndexUtil").parseResourceIndexes(g.src);
            else if (g.p) i = d("HasteResourceIndexUtil").parseResourceIndexes(g.p), i.includes(d("HasteResourceIndexUtil").UNKNOWN_RESOURCE_INDEX) && b.set(f, g), i = i.filter(function(a) {
    ...
    var $ = {
        ...
        handlePayload: function(a, b) {
            ...
            if (c("objectKeys")(i).length) {
                ...
                f !== null && f !== c("SiteData").client_revision ? c("FBLogger")("bootloader", "csr-mismatch").warn("CSR upgrades included on mismatched rev %s (client rev: %s, cohort: %s).", f, c("SiteData").client_revision, c("SiteData").pkg_cohort) : !c("BootloaderConfig").phdSeparateBitmaps && g != null && A ? c("FBLogger")("bootloader", "missing-csr-upgrade").warn("CSR upgrades included unknown rsrcIndex %d (client rev: %s, cohort: %s).", g, c("SiteData").client_revision, c("SiteData").pkg_cohort) : c("objectKeys")(i).forEach(function(a) {
...
__d("getAsyncParams", ["CometPersistQueryParams", "CurrentUserInitialData", "DTSGUtils", "Env", "GetAsyncParamsExtraData", "HasteBitMap", "JSErrorLoggingConfig", "LSD", "ServerJSDefine", "SiteData", "SprinkleConfig", "StaticSiteData", "WebConnectionClassServerGuess", "WebSession", "asyncParams", "cr:8959", "cr:8960", "getAsyncParamsForProfiling", "getAsyncParamsFromCurrentPageURI", "isSocialPlugin", "requireWeak", "uniqueRequestID"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, e) {
        ...
        e || (g[c("StaticSiteData").jsmod_key] = c("ServerJSDefine").getLoadedModuleHash(), g[c("StaticSiteData").csr_key] = d("HasteBitMap").toCompressedString());
...
__d("PluginMessage", ["Arbiter", "CSS", "DOM", "DOMEventListener"], (function(a, b, c, d, e, f, g) {
    ...
    function a() {
        d("DOMEventListener").add(window, "message", function(a) {
            if (/\.facebook\.com$/.test(a.origin) && i().test(a.data)) {
                ...
                "type" in a && (a.type === "messenger_checkbox" ? j(a) : a.type === "customer_chat" && l(a))
            }
        })
    }
    ...
    function j(a) {
        ...
        b != null && e != null && f != null && g != null && (a.can_personalize === !0 ? (k(e, a.profile_photo), k(f, a.profile_name), d("CSS").show(b), k(g, a.checkbox), a.access_token != null && c("Arbiter").inform(h, a.access_token)) : d("CSS").hide(b))
    }
...
__d("ReactDOM", ["cr:1293", "cr:1294159", "cr:7162", "cr:734", "err", "setupReactRefresh"], (function(a, b, c, d, e, f, g) {
    var h, i;
    b("setupReactRefresh");
...
__d("react-forget-runtime", ["invariant", "CometEnvironmentSite", "DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE", "FBLogger", "SiteData", "err", "gkx"], (function(a, b, c, d, e, f, g, h) {
    var i = null,
        j = null,
        k = !1,
        l = a.console,
    ...
    var r = ["useMemoCache", "unstable_useMemoCache", "readContext", "unstable_isNewReconciler", "getCacheSignal", "getCacheForType", "use"];
    a = function() {
        var a = r[s];
        n[a] = function() {
    ...
    function d(a) {
        t = a.isValidElement, i = a.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, a.unstable_useContextWithBailout, a.useContext
    }
    a = !1;
    ...
    function u(a) {
        return (a = t == null ? void 0 : t(a)) != null ? a : !1
    }
    var v = new Set();
        ...
        function k(a, b, d, e) {
            if (e > j) return;
                ...
                if (a === null || b === null)(a !== null || b !== null) && i("type " + (a === null ? "null" : "object"), "type " + (b === null ? "null" : "object"), d, e);
                    ...
                    for (var f = a, g = Array.isArray(f), l = 0, f = g ? f : f[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                        var m;
                        if (g) {
                            if (l >= f.length) break;
                            m = f[l++]
                        ...
                        var n = m[0];
                        m = m[1];
                        !b.has(n) ? i("Map instance with key " + String(n), "Map instance without key " + String(m), d, e) : k(m, b.get(n), d + ".get(" + String(n) + ")", e + 1)
                    ...
                    for (m = b, n = Array.isArray(m), l = 0, m = n ? m : m[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                        if (n) {
                            if (l >= m.length) break;
                            g = m[l++]
                        } else {
                        ...
                        f = g;
                        a.has(f) || i("Set instance without element " + String(f), "Set instance with element " + String(f), d, e)
...
__d("React", ["FBLogger", "cr:1294158", "react-compiler-runtime", "react-forget-runtime", "setupReactRefresh", "shimReactSecretInternals_DEPRECATED"], (function(a, b, c, d, e, f) {
    b("setupReactRefresh");
    a = b("cr:1294158");
...
__d("TooltipData", ["DOM", "DataStore", "FBLogger", "URI", "getElementText", "ifRequired", "isStringNullOrEmpty", "isTextNode", "tooltipPropsFor"], (function(a, b, c, d, e, f, g) {
    ...
    var m = {
        ...
        set: function(a, b, d, e) {
            l(a, b), b instanceof(h || (h = c("URI"))) ? (a.setAttribute("data-tooltip-uri", b.toString()), c("ifRequired")("Tooltip", function(b) {
                b.isActive(a) && b.fetchIfNecessary(a)
            })) : (a.removeAttribute("data-tooltip-content"), m._store({
                context: a,
                content: b,
                position: d,
                alignH: e
        ...
        enableDisplayOnOverflow: function(a) {
            a.removeAttribute("data-tooltip-display"), k(a, {
                overflowDisplay: !0
            })
        },
        enablePersistOnClick: function(a) {
            a.removeAttribute("data-pitloot-persistOnClick"), k(a, {
                persistOnClick: !0
            })
        },
...
__d("ConstUriUtils", ["CometLruCache", "ExecutionEnvironment", "FBLogger", "PHPQuerySerializer", "PHPQuerySerializerNoEncoding", "URIRFC3986", "URISchemes", "UriNeedRawQuerySVConfig", "isSameOrigin", "nullthrows", "recoverableViolation", "structuredClone"], (function(a, b, c, d, e, f, g) {
    ...
    var h, i, j, k, l = d("CometLruCache").create(5e3),
        ...
        q = new RegExp("[\\x00-\\x2c\\x2f\\x3b-\\x40\\x5c\\x5e\\x60\\x7b-\\x7f\\uFDD0-\\uFDEF\\uFFF0-\\uFFFF\\u2047\\u2048\\uFE56\\uFE5F\\uFF03\\uFF0F\\uFF1F]"),
    ...
    function w(a) {
        return a != null && r.some(function(b) {
    ...
    function A(a, b, c, d) {
        ...
        c = B(f, a.originalRawQuery, a.queryParams, b, c, (b = d) != null ? b : a.serializer);
        d = c.length > 0 ? "?" : "";
    ...
    var E = function() {
        ...
        b.getQueryString = function(a) {
            a === void 0 && (a = !1);
            return B(this.domain, this.originalRawQuery, this.queryParams, !1, a, this.serializer)
        };
        ...
        b.isFacebookUri = function() {
            var a = this.toString();
            if (a === "") return !1;
            return !this.getDomain() && !this.getProtocol() ? !0 : ["https", "http"].indexOf(this.getProtocol()) !== -1 && (m.test(this.getDomain()) || n.test(this.getDomain()) || o.test(this.getDomain()))
        };
        ...
        b.setPath = function(a) {
            return a != null ? z(this, {
                path: a
            }) : this
        };
        b.setPort = function(a) {
            return Boolean(a) ? z(this, {
                port: a
            }) : this
        };
    ...
    var F = "for (;;);",
        ...
        H = function() {
            ...
            e._invokeErrorHandler = function(a) {
                ...
                var f, g;
                a = !0;
                if (e === r) g = i._("Pas de connexion r\u00e9seau"), f = i._("Votre navigateur semble d\u00e9connect\u00e9. Veuillez v\u00e9rifier votre connexion internet et recommencer.");
                else if (e >= 300 && e <= 399) {
                    g = i._("Redirection");
                    f = i._("Votre acc\u00e8s \u00e0 Facebook a \u00e9t\u00e9 redirig\u00e9 ou bloqu\u00e9 par un tiers, veuillez contacter votre fournisseur d\u2019acc\u00e8s d\u2019Internet ou r\u00e9actualiser la page.");
                    var h = d.getResponseHeader("Location");
                    h && c("goURI")(h, !0);
                    a = !0
                } else g = i._("Oups\u00a0!"), f = i._("Une erreur s\u2019est produite. Nous tentons de la r\u00e9soudre dans les plus brefs d\u00e9lais. Vous pourrez bient\u00f4t r\u00e9essayer.");
            ...
            e.send = function(b) {
                ...
                d("AdsManagerConstURIUtils").shouldRedirectToAMReadRegions(this.uri.toString()) && this.getReadOnly() && this.method.toLowerCase() === "get" && this.uri.addQueryData({
            ...
            e._canSendCredentials = function() {
                ...
                return c("isFacebookURI")(a) || c("isInternalFBURI")(a) || c("isMessengerDotComURI")(a) || c("isWorkplaceDotComURI")(a) || c("isWorkroomsDotComURI")(a) || c("isWorkDotMetaDotComURI")(a) || c("isHorizonDotMetaDotComURI")(a) || c("isSparkDotMetaDotComURI")(a) || c("isArDotMetaDotComURI")(a)
            };
...
__d("BanzaiAdapterWWW", ["invariant", "Arbiter", "BanzaiConfig", "BanzaiConsts", "BanzaiStorage", "QueryString", "Run", "StaticSiteData", "TimeSlice", "URI", "UserAgent", "ZeroRewrites", "getAsyncHeaders", "getAsyncParams", "justknobx", "once"], (function(a, b, c, d, e, f, g, h) {
    var i, j, k = [],
        l = new(c("Arbiter"))(),
        m = "/ajax/bz",
        n = "POST",
        o = {
            ...
            send: function(a, b, e, f) {
                ...
                c("justknobx")._("2233") && Object.entries(c("getAsyncHeaders")(g)).forEach(function(a) {
                    var b = a[0];
                    a = a[1];
...
__d("isLinkshimURI", ["LinkshimHandlerConfig", "isFacebookURI", "isMessengerDotComURI"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("LinkshimAsyncLink", ["$", "AsyncSignal", "LinkshimHandlerConfig"], (function(a, b, c, d, e, f, g) {
    function h(a, b) {
        a.href = b
    }
...
__d("ThisControllerNoLongerExists", ["XControllerURIBuilder", "XThisControllerNoLongerExistsController", "jsRouteBuilder"], (function(a, b, c, d, e, f, g) {
    ...
    var h = function(b) {
        ...
        function a(a) {
            ...
            c.$XControllerURIBuilderNoOpDead$p_1 = a;
            return c
        }
        var d = a.prototype;
...
__d("PluginShareActions", ["AsyncRequest", "Event", "ThisControllerNoLongerExists"], (function(a, b, c, d, e, f, g) {
    "use strict";

    function a(a, b, e, f, g, h, i) {
        c("Event").listen(g, "click", function(g) {
            new(c("AsyncRequest"))().setURI(d("ThisControllerNoLongerExists").__DEADBUILDER__("g584vh1q").getURI()).setData({
                app_id: h,
                href: a,
                layout: b,
                event: "click",
...
__d("ControlledReferer", ["invariant", "ConstUriUtils", "XRefererFrameControllerRouteBuilder", "getRequestConstUri", "isInternalFBURI", "isWorkplaceDotComURI"], (function(a, b, c, d, e, f, g, h) {
    function i(a, b, e) {
        function f() {
            var c = "";
            try {
        ...
        var g = c("XRefererFrameControllerRouteBuilder").buildUri({
            cb: 1
        });
        g = g;
        c("isInternalFBURI")(c("getRequestConstUri")()) && (g = d("ConstUriUtils").getUri("/intern/common/referer_frame.php"));
        e == null && c("isWorkplaceDotComURI")(c("getRequestConstUri")()) && (e = "workplace");
        if (e) {
            var i;
            g = (i = g) == null ? void 0 : i.addQueryParam("fb_source", e)
        }
        g != null || h(0, 67317);
        a.onload = f;
        a.src = g.toString()
...
__d("TrackingPixel", ["Arbiter", "ControlledReferer", "CookieConsent", "FBLogger"], (function(a, b, c, d, e, f) {
    var g, h = {
        ...
        loadWithNoReferrer: function(a) {
            if (!(g || (g = b("CookieConsent"))).hasFirstPartyConsent()) {
