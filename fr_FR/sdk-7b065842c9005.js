/*1733935300,,JIT Construction: v1018797727,fr_FR*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                    ...
                    var n = c("Type").extend({
                        ...
                        o = {
                            ...
                            _createMobileLoader: function() {
                                var a = document.createElement("div");
                                c("sdk.UA").nativeApp() ? a.innerHTML = '<div class="dialog_header"></div>' : o.isTabletStyle() ? a.innerHTML = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + c("sdk.fbt")._("Annuler") + "</a></div>" : a.innerHTML = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + c("sdk.fbt")._("Annuler") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + c("sdk.fbt")._("Chargement\u2026") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                                return o.create({
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    b = {
                        continueWith: (a = c("sdk.fbt"))._("Continuer avec {facebook_app_name} ou {instagram_app_name}"),
                        continueWithShort: a._("{facebook_app_name} ou {instagram_app_name}"),
                        loginButtonAriaLabel: a._("Continuer avec Facebook ou Instagram"),
                        logout: a._("D\u00e9connexion"),
                        logoutButtonAriaLabel: a._("Se d\u00e9connecter du site web actuel"),
                        titleText: a._("Choisir un compte"),
                        promptText: a._("Quel compte voulez-vous utiliser pour vous connecter\u00a0?"),
                        facebookText: a._("Se connecter avec Facebook"),
                        facebookTextShort: a._("Se connecter"),
                        instagramText: a._("Se connecter avec Instagram"),
                        disambiguationDialogAriaLabelText: a._("Log in with Facebook or Instagram"),
                        fbButtonText: a._("Continuer avec Facebook"),
                        igButtonText: a._("Continuer avec Instagram")
                    };
    ...
    __fb_i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + __fb_err.name + '","line":"' + (__fb_err.lineNumber || __fb_err.line) + '","script":"' + (__fb_err.fileName || __fb_err.sourceURL || __fb_err.script || "sdk.js") + '","stack":"' + (__fb_err.stackTrace || __fb_err.stack) + '","revision":"1018797727","namespace":"FB","message":"' + __fb_err.message + '"}}');
